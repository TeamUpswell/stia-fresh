      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          >
            ...
            {completing && <div className="h-4 w-4 border-2 border-t-transparent border-white rounded-full animate-spin"></div>}
          </button>
          
          <div>
            <span className={task.is_completed ? 'text-gray-500' : 'font-medium'}>
              {taskName}
            </span>
