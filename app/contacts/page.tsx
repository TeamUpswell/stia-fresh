...
import { useProperty } from "@/lib/hooks/useProperty"; // ✅ Add property context
...
export default function ContactsPage() {
  ...
  // ✅ Update the contacts query to filter by property (if needed)
  useEffect(() => {
    async function loadData() {
      try {
        ...
        const { data: contactsData, error: contactsError } = await supabase
          .from("contacts")
          .select("*")
          // ✅ Add property filter if contacts are property-specific:
  ...
  }, [user, currentProperty]); // ✅ Add currentProperty dependency if contacts are property-specific
  ...
  return (
    <AuthenticatedLayout>
      {/* ✅ Remove the SideNavigation wrapper and simplify structure */}
